This study focuses on optimizing customer targeting through telemarketing to promote long-term deposit accounts. Calls can either be initiated by the bank (outbound) or by the customer (inbound), with a binary outcome: success or failure.

The study is based on real data from a Portuguese bank, collected between May 2008 and June 2013, covering a total of 41,187 phone contacts. 

The steps to realize this project are:
